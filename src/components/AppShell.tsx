      ...
      <div className="min-h-screen flex items-center justify-center px-6 text-center">
        <div className="glass rounded-2xl p-8 max-w-md">
          ...
          <p className="text-muted-foreground mt-3">
            Aap signed in ho, lekin access sync nahi hua ya manager access abhi assign nahi hua. Ek
            baar retry karke dekho.
          </p>
    ...
    <div className="min-h-screen flex">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 glass flex items-center justify-between px-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded bg-gold text-primary-foreground flex items-center justify-center font-bold">
            D
          </div>
      ...
      >
        <div className="px-6 py-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gold text-primary-foreground flex items-center justify-center font-bold">
              D
            </div>
            <div>
        ...
        <div className="p-4 border-t border-sidebar-border">
          ...
          <div className="text-[10px] tracking-widest text-gold mt-0.5">
            {isOwner ? "OWNER" : "MANAGER"}
          </div>
          <Button onClick={signOut} variant="outline" size="sm" className="w-full mt-3">
